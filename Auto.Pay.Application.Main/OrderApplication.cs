...
namespace Auto.Pay.Aplicacion.Main
{
    ...
    public class OrderApplication : IOrderApplication
	{
		...
		{
            OrderEBL orderEBL = registerOrderDTO.ConvertToEntity();

            return _managerBusinessLogic.Order.RegisterOrder(orderEBL);
		}
		public EntityBusinessLogic StatusOrden(string orderId, string paymentReference, string language)
        {
            return _managerBusinessLogic.Order.StatusOrden(orderId,  paymentReference,  language);
		}
